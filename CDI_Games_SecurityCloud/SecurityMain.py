...
# Set the TIMER event to be triggered every second
...
# Load title image
title_image = pygame.image.load('CDI_Games_SecurityCloud/images/network_invaders.png').convert_alpha()

# Load custom font
custom_font_path = 'CDI_Games_SecurityCloud/font/Minecraft.ttf'  # Path to your custom font file
font = None  # Load the custom font with size 36
...
firewall_image = pygame.image.load('CDI_Games_SecurityCloud/images/firewall_concept_sprite.png')
...
# Timer to delay the display of the start text
start_time = time.time()

# Startscherm
Startscherm = True

# Load the controls images
controls_image_arrows = pygame.image.load('CDI_Games_SecurityCloud/images/controlls_arrows_sprite.png').convert_alpha()
controls_image_arrows = pygame.transform.scale(controls_image_arrows, (400, 300))  # Adjust the size as needed

controls_image_spatie = pygame.image.load('CDI_Games_SecurityCloud/images/controlls_spatie_sprite.png').convert_alpha()
...
sprites_image_hacker = pygame.image.load('CDI_Games_SecurityCloud/images/hacker_sprite.png').convert_alpha()
sprites_image_hacker = pygame.transform.scale(sprites_image_hacker, (100, 100))  # Adjust the size as needed

sprites_image_firewall = pygame.image.load('CDI_Games_SecurityCloud/images/firewall_concept_sprite.png').convert_alpha()
sprites_image_firewall = pygame.transform.scale(sprites_image_firewall, (100, 100))  # Adjust the size as needed

sprites_image_router = pygame.image.load('CDI_Games_SecurityCloud/images/router.png').convert_alpha()
sprites_image_router = pygame.transform.scale(sprites_image_router, (100, 100))  # Adjust the size as needed

sprites_image_laptop = pygame.image.load('CDI_Games_SecurityCloud/images/laptop.png').convert_alpha()
sprites_image_laptop = pygame.transform.scale(sprites_image_laptop, (100, 100))  # Adjust the size as needed
...
while Startscherm:
    ...
    # display the standard text with game explanation
    display.blit(text, text_rect)
    ...
    display.blit(text8, (250, 700))
    display.blit(text9, (250, 800))
    display.blit(text10, (650, 800))
    display.blit(text11, (1050, 800))
    display.blit(text12, (1450, 800))
    ...
    sprites_image_hacker_rect = sprites_image_hacker.get_rect(center=(300, 900))
    display.blit(sprites_image_hacker, sprites_image_hacker_rect)

    sprites_image_firewall_rect = sprites_image_firewall.get_rect(center=(700, 900))
    display.blit(sprites_image_firewall, sprites_image_firewall_rect)

    sprites_image_router_rect = sprites_image_router.get_rect(center=(1100, 900))
    display.blit(sprites_image_router, sprites_image_router_rect)

    sprites_image_laptop_rect = sprites_image_laptop.get_rect(center=(1500, 900))
    display.blit(sprites_image_laptop, sprites_image_laptop_rect)
