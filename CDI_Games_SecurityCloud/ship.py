...
class Ship(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('CDI_Games_SecurityCloud/images/laptop.png').convert_alpha() # Laadt de foto van het schip in image, convert is zodat de game niet lagt
